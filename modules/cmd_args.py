...
parser.add_argument("--launch-ui", action='store_true', help="Start the web UI. Useful to disable to run preparation scripts without launching the UI.", default=True)
