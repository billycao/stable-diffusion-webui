...
parser.add_argument("--skip-ui", action='store_true', help="Skip starting the web UI. Useful for running preparation scripts without launching the UI.", default=False)
